...
> - **Phase 2 — Multi-charger plan**: [`docs/documentation/milestones/02-2026-05-22-multi-charger-plan.md`](../documentation/milestones/02-2026-05-22-multi-charger-plan.md) — multi-charger support design abstraction covering the data model, distribution algorithm, and runtime behaviour.
